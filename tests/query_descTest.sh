...
declare -r TEST_QUERY_DESC_VIEW_FIELD_REQUEST='([FULL]="0" [VIEW]="1" [QUERY]="DESC CAMPAIGN_REPORT Id" [STATEMENT]="DESC" [METHOD]="desc" [FIELD]="Id" [TABLE]="CAMPAIGN_REPORT" [API_VERSION]="v201601" )'
