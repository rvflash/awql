...
declare -r TEST_QUERY_BASIC_DESC_REQUEST='([FULL]="0" [VIEW]="0" [QUERY]="DESC CAMPAIGN_PERFORMANCE_REPORT" [STATEMENT]="DESC" [METHOD]="desc" [TABLE]="CAMPAIGN_PERFORMANCE_REPORT" [API_VERSION]="v201601" )'
declare -r TEST_QUERY_FULL_DESC="desc full CAMPAIGN_PERFORMANCE_REPORT"
declare -r TEST_QUERY_FULL_DESC_REQUEST='([FULL]="1" [VIEW]="0" [QUERY]="desc full CAMPAIGN_PERFORMANCE_REPORT" [STATEMENT]="desc full" [METHOD]="desc" [TABLE]="CAMPAIGN_PERFORMANCE_REPORT" [API_VERSION]="v201601" )'
declare -r TEST_QUERY_FULL_DESC_FIELD="desc full CAMPAIGN_PERFORMANCE_REPORT CampaignId"
declare -r TEST_QUERY_FULL_DESC_FIELD_REQUEST='([FULL]="1" [VIEW]="0" [QUERY]="desc full CAMPAIGN_PERFORMANCE_REPORT CampaignId" [STATEMENT]="desc full" [METHOD]="desc" [FIELD]="CampaignId" [TABLE]="CAMPAIGN_PERFORMANCE_REPORT" [API_VERSION]="v201601" )'
declare -r TEST_QUERY_DESC_FIELD="DESC CAMPAIGN_PERFORMANCE_REPORT CampaignId"
declare -r TEST_QUERY_DESC_FIELD_REQUEST='([FULL]="0" [VIEW]="0" [QUERY]="DESC CAMPAIGN_PERFORMANCE_REPORT CampaignId" [STATEMENT]="DESC" [METHOD]="desc" [FIELD]="CampaignId" [TABLE]="CAMPAIGN_PERFORMANCE_REPORT" [API_VERSION]="v201601" )'
declare -r TEST_QUERY_DESC_VIEW="DESC CAMPAIGN_REPORT"
declare -r TEST_QUERY_DESC_VIEW_REQUEST='([FULL]="0" [VIEW]="1" [QUERY]="DESC CAMPAIGN_REPORT" [STATEMENT]="DESC" [METHOD]="desc" [TABLE]="CAMPAIGN_REPORT" [API_VERSION]="v201601" )'
declare -r TEST_QUERY_DESC_VIEW_FIELD="DESC CAMPAIGN_REPORT CampaignId"
declare -r TEST_QUERY_DESC_VIEW_FIELD_REQUEST='([FULL]="0" [VIEW]="1" [QUERY]="DESC CAMPAIGN_REPORT CampaignId" [STATEMENT]="DESC" [METHOD]="desc" [FIELD]="CampaignId" [TABLE]="CAMPAIGN_REPORT" [API_VERSION]="v201601" )'
