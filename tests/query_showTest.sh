...
declare -r TEST_QUERY_BASIC_SHOW_REQUEST='([FULL]="0" [QUERY]="SHOW TABLES" [STATEMENT]="SHOW TABLES" [METHOD]="show" [AWQL_QUERY]="SHOW TABLES" [API_VERSION]="v201603" )'
declare -r TEST_QUERY_FULL_SHOW="show full tables"
declare -r TEST_QUERY_FULL_SHOW_REQUEST='([FULL]="1" [QUERY]="show full tables" [STATEMENT]="SHOW FULL TABLES" [METHOD]="show" [AWQL_QUERY]="SHOW FULL TABLES" [API_VERSION]="v201603" )'
declare -r TEST_QUERY_FULL_LIKE_SHOW="SHOW FULL TABLES LIKE \"CAMPAIGN%\""
declare -r TEST_QUERY_FULL_LIKE_SHOW_REQUEST="([FULL]=\"1\" [QUERY]=\"SHOW FULL TABLES LIKE \\\"CAMPAIGN%\\\"\" [STATEMENT]=\"SHOW FULL TABLES\" [LIKE]=\"CAMPAIGN%\" [METHOD]=\"show\" [AWQL_QUERY]=\"SHOW FULL TABLES LIKE 'CAMPAIGN%'\" [API_VERSION]=\"v201603\" )"
declare -r TEST_QUERY_LIKE_SHOW="show tables like 'CAMPAIGN%'"
declare -r TEST_QUERY_LIKE_SHOW_REQUEST="([FULL]=\"0\" [QUERY]=\"show tables like 'CAMPAIGN%'\" [STATEMENT]=\"SHOW TABLES\" [LIKE]=\"CAMPAIGN%\" [METHOD]=\"show\" [AWQL_QUERY]=\"SHOW TABLES LIKE 'CAMPAIGN%'\" [API_VERSION]=\"v201603\" )"
declare -r TEST_QUERY_INCOMPLETE_LIKE_SHOW="SHOW TABLES LIKE"
declare -r TEST_QUERY_EMPTY_LIKE_SHOW="SHOW TABLES LIKE \"\""
declare -r TEST_QUERY_EMPTY_LIKE_SHOW_REQUEST='([FULL]="0" [QUERY]="SHOW TABLES LIKE \"\"" [STATEMENT]="SHOW TABLES" [LIKE]="" [METHOD]="show" [AWQL_QUERY]="SHOW TABLES" [API_VERSION]="v201603" )'
declare -r TEST_QUERY_FULL_WITH_SHOW="show full tables with 'ViewThroughConversions'"
declare -r TEST_QUERY_FULL_WITH_SHOW_REQUEST="([FULL]=\"1\" [QUERY]=\"show full tables with 'ViewThroughConversions'\" [STATEMENT]=\"SHOW FULL TABLES\" [METHOD]=\"show\" [WITH]=\"ViewThroughConversions\" [AWQL_QUERY]=\"SHOW FULL TABLES WITH 'ViewThroughConversions'\" [API_VERSION]=\"v201603\" )"
declare -r TEST_QUERY_WITH_SHOW="SHOW TABLES WITH 'ViewThroughConversions'"
declare -r TEST_QUERY_WITH_SHOW_REQUEST="([FULL]=\"0\" [QUERY]=\"SHOW TABLES WITH 'ViewThroughConversions'\" [STATEMENT]=\"SHOW TABLES\" [METHOD]=\"show\" [WITH]=\"ViewThroughConversions\" [AWQL_QUERY]=\"SHOW TABLES WITH 'ViewThroughConversions'\" [API_VERSION]=\"v201603\" )"
declare -r TEST_QUERY_EMPTY_WITH_SHOW="SHOW TABLES WITH \"\""
declare -r TEST_QUERY_EMPTY_WITH_SHOW_REQUEST='([FULL]="0" [QUERY]="SHOW TABLES WITH \"\"" [STATEMENT]="SHOW TABLES" [METHOD]="show" [WITH]="" [AWQL_QUERY]="SHOW TABLES" [API_VERSION]="v201603" )'
