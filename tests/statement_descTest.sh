...
declare -r TEST_STATEMENT_DESC_REQUEST='([FULL]="0" [VIEW]="0" [QUERY]="DESC CAMPAIGN_PERFORMANCE_REPORT" [STATEMENT]="DESC" [METHOD]="desc" [TABLE]="CAMPAIGN_PERFORMANCE_REPORT" [API_VERSION]="v201605" )'
declare -r TEST_STATEMENT_DESC_FULL_REQUEST='([FULL]="1" [VIEW]="0" [QUERY]="desc full CAMPAIGN_PERFORMANCE_REPORT" [STATEMENT]="desc full" [METHOD]="desc" [TABLE]="CAMPAIGN_PERFORMANCE_REPORT" [API_VERSION]="v201605" )'
declare -r TEST_STATEMENT_DESC_FULL_FIELD_REQUEST='([FULL]="1" [VIEW]="0" [QUERY]="desc full CAMPAIGN_PERFORMANCE_REPORT CampaignId" [STATEMENT]="desc full" [METHOD]="desc" [FIELD]="CampaignId" [TABLE]="CAMPAIGN_PERFORMANCE_REPORT" [API_VERSION]="v201605" )'
declare -r TEST_STATEMENT_DESC_FIELD_REQUEST='([FULL]="0" [VIEW]="0" [QUERY]="DESC CAMPAIGN_PERFORMANCE_REPORT CampaignId" [STATEMENT]="DESC" [METHOD]="desc" [FIELD]="CampaignId" [TABLE]="CAMPAIGN_PERFORMANCE_REPORT" [API_VERSION]="v201605" )'
declare -r TEST_STATEMENT_DESC_VIEW_REQUEST='([FULL]="0" [VIEW]="1" [QUERY]="DESC CAMPAIGN_REPORT" [STATEMENT]="DESC" [METHOD]="desc" [TABLE]="CAMPAIGN_REPORT" [API_VERSION]="v201605" )'
declare -r TEST_STATEMENT_DESC_VIEW_FIELD_REQUEST='([FULL]="0" [VIEW]="1" [QUERY]="DESC CAMPAIGN_REPORT Id" [STATEMENT]="DESC" [METHOD]="desc" [FIELD]="Id" [TABLE]="CAMPAIGN_REPORT" [API_VERSION]="v201605" )'
